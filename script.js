var player = 100; //This is your limit of number you're login.
...
var magical = Math.floor(Math.random() *player); //This is the mathematical part(Math.floor(Math.random() with *player is not constant it can be substituded) that does the random selection for you in the background.
//Below are the necessary condition for a best ou put.
